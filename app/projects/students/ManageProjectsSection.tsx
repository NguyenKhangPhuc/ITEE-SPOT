'use client'
import { getUserSubmittedProjects, getAllProjectsBasedOnStatus, getSingleProjectByGroupAndChallenge } from "@/app/actions/projects"
...
interface ManageProjectsSectionProps {
    ...
    setUserProjects: React.Dispatch<SetStateAction<Array<ProjectsSummaryExtended>>>
}

const ManageProjectsSection = ({ page, userProjects, setUserProjects }: ManageProjectsSectionProps) => {
    ...
    const handleChooseProject = async (project: ProjectsSummaryExtended) => {
        setIsOpenLoader(true)
        try {
                ...
                <table className="w-full min-w-max border-collapse">
                    <thead>
                        <tr className="bg-black text-white">
                            ...
                            <th className="w-50  0  p-4 border-r border-white border-b-4 border-b-black text-center">Edit</th>
